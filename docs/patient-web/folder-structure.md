...
Dự án Patient Web áp dụng mô hình kiến trúc **Feature-Sliced Design (Biến thể)**. Mô hình này giúp code không bị rối khi dự án lớn lên, vì mọi logic liên quan đến một tính năng được gom lại vào một chỗ.
