  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <StatsCard icon={<Package size={16} />} label="Tổng dịch vụ" value={summary.totalServices} bgColor="bg-blue-50" iconColor="text-blue-600" />
        <StatsCard icon={<TrendingUp size={16} />} label="Tổng lượt chỉ định" value={summary.totalOrders} bgColor="bg-purple-50" iconColor="text-purple-600" />
        <StatsCard icon={<Award size={16} />} label="Tổng doanh thu" value={summary.totalRevenue.toLocaleString() + 'đ'} bgColor="bg-emerald-50" iconColor="text-emerald-600" />
      </div>
