// features/pharmacy/components/MedicineFormDialog.tsx
import React from 'react';
import { Pill } from 'lucide-react';
import FormDialog, { FieldConfig } from '@/components/common/FormDialog';

const medicineFields: FieldConfig[] = [
  { name: 'name', label: 'Tên thuốc', type: 'text', required: true, placeholder: 'Ví dụ: Paracetamol 500mg', colSpan: 2 },
  ...
  { name: 'usageNote', label: 'Hướng dẫn sử dụng', type: 'text', required: false, placeholder: 'Ví dụ: Ngày uống 2 lần...', colSpan: 2 },
];
