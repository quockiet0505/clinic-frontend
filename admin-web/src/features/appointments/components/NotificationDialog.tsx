      ...
      <DialogContent className="sm:max-w-[450px] p-0 overflow-hidden border-0 rounded-[32px] shadow-2xl">
        <div className="bg-amber-500 p-6 text-white">
          <div className="flex items-center gap-2 mb-2 opacity-90">
            <BellRing size={16} /> <span className="text-xs font-bold uppercase tracking-widest">Send Notification</span>
          </div>
          <DialogTitle className="text-xl font-black">Remind {patient.patient_name}</DialogTitle>
        ...
        <div className="p-6 bg-slate-50 space-y-4">
          <div className="space-y-2">
            ...
            <select value={type} onChange={(e) => setType(e.target.value)} className="flex h-11 w-full rounded-xl border border-slate-200 bg-white px-3 font-bold focus:ring-2 focus:ring-amber-500 outline-none">
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              className="flex w-full rounded-xl border border-slate-200 bg-white p-3 font-medium focus:ring-2 focus:ring-amber-500 outline-none resize-none h-24"
