...
const fields: FieldConfig[] = [
  { name: 'patientName', label: 'Tên bệnh nhân / Mã bệnh án', type: 'text', required: true, placeholder: 'Tìm kiếm bệnh nhân...' },
  { name: 'serviceName', label: 'Chọn xét nghiệm', type: 'select', required: true, options: [
  ...
  { name: 'doctorName', label: 'Bác sĩ chỉ định', type: 'text', required: true, placeholder: 'vd: BS. Nguyễn Văn A' },
];
