    ...
    <div className="bg-white p-10 sm:p-16 border border-slate-200 rounded-[32px] shadow-sm max-w-3xl mx-auto print:border-none print:shadow-none print:p-0">
      <div className="flex justify-between items-start border-b border-slate-100 pb-8 mb-8">
        <div>
          ...
          <p className="text-slate-500 font-bold mt-1">#BILL-{data.billId}</p>
        </div>
      ...
      <div className="flex justify-between mb-10">
        ...
        <div className="text-right">
          ...
          <p className="font-bold text-slate-900">{data.paymentMethod || 'N/A'}</p>
        </div>
      </div>
      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b-2 border-slate-200">
            <th className="py-3 font-bold text-slate-600 text-sm">Mô tả</th>
            <th className="py-3 font-bold text-slate-600 text-sm text-center">Qty</th>
            <th className="py-3 font-bold text-slate-600 text-sm text-right">Tổng</th>
          </tr>
        </thead>
