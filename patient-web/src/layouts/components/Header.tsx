...
export const Header: React.FC = () => {
  ...
  return (
    <header
      className={`sticky top-0 z-[100] w-full transition-all duration-300 bg-white/95 backdrop-blur-md ${
        isScrolled ? 'shadow-md border-b border-slate-100 py-2' : 'border-b border-slate-100 py-4'
      }`}
    >
